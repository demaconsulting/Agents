...
Subsystems may nest recursively, for example as `docs/verification/{system-name}[/{subsystem-name}...]/{subsystem-name}.md` or `docs/verification/{system-name}[/{subsystem-name}...]/{unit-name}.md`.
